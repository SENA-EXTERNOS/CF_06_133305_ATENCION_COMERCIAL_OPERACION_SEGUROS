...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.bloque-fondo1
    ...
    p.mt-4 Las organizaciones se clasifican según diversos criterios que permiten categorizarlas en distintos tipos, algunos de estos son:
      b la estructura, los ingresos, la propiedad y el tamaño.
    
    p.mt-4 Cada uno de estos criterios de las organizaciones están conformados de la siguiente manera:
    ...
    .row.justify-content-center
      ...
      .row.justify-content-center.align-items-start.mt-5      
        .col-lg-6
            LineaTiempoD   
              .row(numero="1" titulo="A largo plazo")
                .col-lg-2
                  img(src='@/assets/curso/temas/tema1/img12.svg' )           
                .col-lg-9
                  p.text-small Suponen objetivos de largo alcance, apuntan a lograr sostenibilidad en el tiempo y pueden estar orientadas, por ejemplo, a lograr la participación de la organización en el mercado nacional.
              
              .row(numero="2" titulo="A corto plazo")
                .col-md-2
                  img(src='@/assets/curso/temas/tema1/img13.svg'  )
                .col-lg-9
                  p.text-small Guardan relación con situaciones que se deben resolver en un plazo corto y se presentan en el diario vivir de la organización. Como ejemplo de este tipo de política está la atención a clientes enojados.

              .row(numero="3" titulo="Financieras")
                .col-md-2
                  img(src='@/assets/curso/temas/tema1/img14.svg' )
                .col-lg-9
                  p.text-small Establecen lineamientos del manejo, el direccionamiento y el control de las áreas de contabilidad, tesorería y tributaria. 

              .row(numero="4" titulo="Operacionales")
                .col-md-2
                  img(src='@/assets/curso/temas/tema1/img15.svg' )
                .col-lg-9
                  p.text-small Son aplicadas en el proceso de producción de la organización y buscan garantizar el uso eficiente y eficaz de los recursos.
                  
        .col-lg-6
          LineaTiempoD
              .row(numero="5" titulo="Personales ")
                .col-md-2
                  img(src='@/assets/curso/temas/tema1/5.svg' )
                .col-lg-9
                  p.text-small Establecen pautas relacionadas con el área de recursos humanos.

              .row(numero="6" titulo="De mercado ")
                .col-md-2
                  img(src='@/assets/curso/temas/tema1/img16.svg' )
                .col-lg-9
                  p.text-small Establecen lineamientos para el mercadeo, la publicidad y las ventas.

              
              .row(numero="7" titulo="Generales")
                .col-md-2
                  img(src='@/assets/curso/temas/tema1/img17.svg' )
                .col-lg-9
                  p.text-small Hacen referencia a la globalidad de la organización, se basan en los principios fundantes que deben responder a la estrategia corporativa y su naturaleza, y son el referente para las políticas específicas de la organización.
                

              .row(numero="8" titulo="Específicas")
                .col-md-2
                  img(src='@/assets/curso/temas/tema1/img17.svg' )
                .col-lg-9
                  p.text-small Son aplicadas en las diferentes áreas de la organización y su alcance se orienta a las acciones, los procedimientos y las decisiones que se adoptan o llevan a cabo. Entre ellas se encuentran las políticas específicas de seguridad y salud en el trabajo, gestión del cambio, recursos humanos, calidad, gestión ambiental, responsabilidad social y empresarial.  
                 

    h5.mt-5 Políticas de gestión del cambio 

    p.mt-4 Por otra parte, dentro de las políticas de una organización se encuentran 
